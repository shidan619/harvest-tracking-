...
class Signup extends Component{
    ...
    clickSubmit = ()=>{
        ...
        create(user,{t:jwt.token}).then((data)=>{
            if(data.error){
            ...
            <Card className={classes.card}>
                <CardContent>
                    ...
                    <TextField id="password" type="password"
                               ...
                               margin="normal"/><br/>
                    <TextField id="division" type="text"
                               label="division" className={classes.textField}
                               value={this.state.division}
                               onChange={this.handleChange('division')}
                               margin="normal"/><br/>
                    <TextField id="contactNo" type="tel"
                               label="contactNo" className={classes.textField}
